...
import { requestRevision } from "redux/actions/order";

const RequestRevisionModal = ({
  requestCancelationRef,
  openRequestRevision,
  handleCloseRequestRevision,
  orderId,
}) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      dispatch(
        requestRevision(values, orderId, resetForm, handleCloseRequestRevision)
      );
    },
  });
        ...
        <form id="send-offer-form" onSubmit={formik.handleSubmit}>
          ...
          >
            ...
            <div className="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
              ...
              <button
                type="button"
                onClick={handleCloseRequestRevision}
