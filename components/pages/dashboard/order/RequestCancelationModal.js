...
const RequestCancelationModal = ({
  requestCancelationModalRef,
  ...
  return (
    <div
      className={`${
        !openRequestCancelationModal && "hidden"
    ...
    >
      <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div
          ref={requestCancelationModalRef}
        ...
        >
                    ...
                    <div>
                      ...
                      <div className="mt-1 relative rounded-md shadow-sm">
                        <textarea
                          ...
                          placeholder="Reasons"
                          aria-describedby="reasons-reasons"
                      ...
                      {formik.touched.reasons && formik.errors.reasons && (
                        <p class="mt-2 text-sm text-red-600" id="reasons-error">
                          {formik.errors.reasons}
                        </p>
                      )}
                      {/* <p className="mt-2 text-sm text-gray-500">
                        Brief reasons for your profile. URLs are
                        hyperlinked.
                      </p> */}
                    </div>
                  </div>
          ...
          <div className="mt-5 sm:mt-6 sm:grid sm:grid-cols-2 sm:gap-3 sm:grid-flow-row-dense">
            ...
            <button
              type="button"
              onClick={handleCloseRequestCancelationModal}
...
export default RequestCancelationModal;
