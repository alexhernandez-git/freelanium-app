      ...
      <div className="relative py-16 bg-white overflow-hidden">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
            <p>Welcome to freelanium.com!</p>
            <p>
              These terms and conditions outline the rules and regulations for
              the use of Freelanium's Website, located at
              https://freelanium.com.
            </p>
            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use freelanium.com if you do not
            ...
            <p>
              We employ the use of cookies. By accessing freelanium.com, you
              agreed to use cookies in agreement with the Freelanium's Privacy
              Policy.{" "}
            </p>
            <p>
            ...
            <p>
              Unless otherwise stated, Freelanium and/or its licensors own the
              intellectual property rights for all material on freelanium.com.
              All intellectual property rights are reserved. You may access this
              from freelanium.com for your own personal use subjected to
              restrictions set in these terms and conditions.
            </p>
            <p>You must not:</p>
            <ul>
              <li>Republish material from freelanium.com</li>
              <li>Sell, rent or sub-license material from freelanium.com</li>
              <li>Reproduce, duplicate or copy material from freelanium.com</li>
              <li>Redistribute content from freelanium.com</li>
            </ul>
            <p>
            ...
            <p>
              ...
              Freelanium does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of Freelanium,its agents and/or affiliates.
              ...
              laws, Freelanium shall not be liable for the Comments or for any
            ...
            <p>
              Freelanium reserves the right to monitor all Comments and to
            ...
            <p>
              You hereby grant Freelanium a non-exclusive license to use,
            ...
            <p>
              ...
              Freelanium; and (d) the link is in the context of general resource
              information.
            </p>
            <p>
            ...
            <p>
              ...
              by sending an e-mail to Freelanium. Please include your name, your
            ...
            <p>
              No use of Freelanium's logo or other artwork will be allowed for
